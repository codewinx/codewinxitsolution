...
export default function CareerPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white px-6 md:px-12 lg:px-20">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-42 pb-20">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 animate-pulse"></div>
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-bold mb-6 text-white animate-fade-in">
            Build Your Future with
          </h2>
          <h3 className="text-3xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-[#00c2ff] via-[#5b4bff] to-[#ff3bcd] text-transparent bg-clip-text">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="group bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm p-6 md:p-7 rounded-3xl border border-slate-700/50 hover:border-blue-500/50 transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/30 animate-float-up cursor-pointer"
      ...
      <section className="py-18 bg-slate-900/50">
        <div className="mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-x-10">
              ...
              <div className="space-y-8">
                {positions.map((position, index) => (
                  ...
                  >
                    ...
                    <button className="w-full h-10 py-4 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-2 group-hover:gap-4 shadow-lg group-hover:shadow-purple-500/50">
                      View Details{" "}
