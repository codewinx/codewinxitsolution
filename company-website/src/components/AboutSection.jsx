    ...
    <section className="min-h-screen bg-linear-to-b from-[#02030a] via-[#05060f] to-[#080b16] text-white py-24 px-6">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="text-center">
          ...
          <button className="mt-5 bg-linear-to-r from-[#00c2ff] via-[#5b4bff] to-[#ff3bcd] px-8 py-3 rounded-xl text-lg font-semibold shadow-lg hover:opacity-90 transition">
            Contact Us
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-24 grid gap-10 sm:grid-cols-3">
        {[
          ...
          >
            <h3 className="text-5xl font-bold bg-linear-to-r from-[#00c2ff] via-[#5b4bff] to-[#ff3bcd] text-transparent bg-clip-text">
              {stat.number}
            </h3>
      ...
      <div className="max-w-7xl mx-auto mt-28">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {[
            ...
            >
              <h3 className="text-2xl font-semibold mb-3 bg-linear-to-r from-[#00c2ff] via-[#5b4bff] to-[#ff3bcd] text-transparent bg-clip-text">
                {card.title}
              </h3>
